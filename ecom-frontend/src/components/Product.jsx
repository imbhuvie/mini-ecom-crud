...
const Product = () => {
  ...
  useEffect(() => {
    ...
    // Set the image URL in your state or wherever you're storing it
    ...
    <>
      <div className="containers" style={{ display: "flex" }}>
        <img
          ...
          // src={"https://images.unsplash.com/photo-1721775551177-3c6da363fdf0?q=80&w=1936&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
          src={imageUrl}
          // src={"data:image/*;base64,${props.generated"}
